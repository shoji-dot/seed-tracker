...
const routes = [
  ...
  { path: '/seeds/:seedId/activities/select', name: 'activity-select', component: () => import('../views/ActivityTypeSelect.vue') },
  { path: '/seeds/:seedId/activities/new/:type', name: 'activity-new', component: () => import('../views/ActivityForm.vue') },
  { path: '/seeds/:seedId/activities/:activityId/edit/:type', name: 'activity-edit', component: () => import('../views/ActivityForm.vue') },
